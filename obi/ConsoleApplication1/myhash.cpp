...
void myhash::Blake2b_36(void* input, int len, unsigned char* output)
{
	b36.CalculateDigest((CryptoPP::byte*)output, (CryptoPP::byte*)input, len);
	counter1++;
}
